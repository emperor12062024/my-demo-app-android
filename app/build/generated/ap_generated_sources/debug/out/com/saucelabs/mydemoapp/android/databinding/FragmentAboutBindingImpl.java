...
public class FragmentAboutBindingImpl extends FragmentAboutBinding  {
    ...
    static {
        ...
        sViewsWithIds.put(R.id.aboutTV, 1);
        sViewsWithIds.put(R.id.titleIV, 2);
        sViewsWithIds.put(R.id.versionTV, 3);
        sViewsWithIds.put(R.id.teamIV, 4);
        sViewsWithIds.put(R.id.webTV, 5);
    }
    // views
    @NonNull
