...
public class FragmentWebViewBindingImpl extends FragmentWebViewBinding  {
    ...
    static {
        ...
        sViewsWithIds.put(R.id.loadingIV, 1);
        sViewsWithIds.put(R.id.loadingTV, 2);
        sViewsWithIds.put(R.id.webView, 3);
        sViewsWithIds.put(R.id.errorCL, 4);
        sViewsWithIds.put(R.id.errorTV, 5);
        sViewsWithIds.put(R.id.domainTV, 6);
        sViewsWithIds.put(R.id.errorCodeTV, 7);
        sViewsWithIds.put(R.id.errorNameTV, 8);
    }
    // views
    @NonNull
